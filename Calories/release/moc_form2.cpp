...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Form2_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Form2_t qt_meta_stringdata_Form2 = {
    {
        QT_MOC_LITERAL(0, 5),  // "Form2"
        QT_MOC_LITERAL(6, 5),  // "slot2"
        QT_MOC_LITERAL(12, 0),  // ""
...
Q_CONSTINIT static const uint qt_meta_data_Form2[] = {
...
Q_CONSTINIT const QMetaObject Form2::staticMetaObject = { {
    ...
    qt_meta_stringdata_Form2.offsetsAndSizes,
    qt_meta_data_Form2,
    qt_static_metacall,
    nullptr,
...
void Form2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->slot2((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
